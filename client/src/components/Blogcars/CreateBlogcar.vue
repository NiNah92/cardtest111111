      ...
      <b-row class="text-left">
        ...
        <b-col cols="10" class="bg1">
          <center>
            ...
            <h5>กรอกข้อมูลเพื่อใช้ในการจองรถ</h5></center>
          <hr/>
          <form class="box1" v-on:submit.prevent="createBlogcar">
            ...
            <p> ชื่อรถ : <input type="tel" class="form-control" required v-model=" blogcar.other" /></p>
            <p> ระดับการให้บริการ :
            ...
            <p>
              ...
              <b-button variant="secondary" v-on:click="navigateTo('/blogcars')"><i class="fa fa-arrow-left">ย้อนกลับ</i></b-button>
            </p>
          </form>
        </b-col>
        <b-col> </b-col>
...
export default {
  ...
  methods: {
    async createBlogcar() {
      this.blogcar.pictures = JSON.stringify(this.pictures); 
      try {
        await BlogcarService.post(this.blogcar);
        this.$router.push({
          name: "blogcars"
        });
      } catch (err) {
